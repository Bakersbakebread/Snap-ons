...
class FNAF:
    ...
    async def fnafquote(self):
        ...
        quote['8'] = '**Circus Baby:** I  wonder, though, if you were a freshly opened pint of ice cream, how you would feel about something with that name. Thankfully, I don\'t think a freshly opened pint of ice cream feels anything at all.'
