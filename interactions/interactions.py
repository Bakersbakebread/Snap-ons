...
class Interactions:
    ...
    async def interact(self, context, user : discord.Member):
        ...
        interaction = {}
        interaction['1'] = '{0} winks at {1}.'.format(executer, victim)
        interaction['2'] = '{0} hugs {1}.'.format(executer, victim)
        interaction['3'] = '{0} shakes hands with {1}.'.format(executer, victim)
        interaction['4'] = '{0} bows down to {1}.'.format(executer, victim)
        interaction['5'] = '{0} pokes {1}.'.format(executer, victim)
        interaction['6'] = '{0} tickles {1}.'.format(executer, victim)
        interaction['7'] = '{0} slaps {1}.'.format(executer, victim)
        interaction['8'] = '{0} scratches {1}.'.format(executer, victim)
        interaction['9'] = '{0} bites {1}.'.format(executer, victim)
        interaction['10'] = '{0} sells {1} for a dime.'.format(executer, victim)
        interaction['11'] = '{0} canes {1}.'.format(executer, victim)
        interaction['12'] = '{0} whips {1}.'.format(executer, victim)
        interaction['13'] = '{0} restrains {1}'.format(executer, victim)
        interaction['14'] = '{0} kneels down to {1}.'.format(executer, victim)
        interaction['15'] = '{0} gets the box of toys out from {1}.'.format(executer, victim)
        interaction['16'] = '{0} ties up {1}.'.format(executer, victim)
        interaction['17'] = '{0} ties up and tickles {1}.'.format(executer, victim)
        interaction['18'] = '{0} kisses {1}.'.format(executer, victim)
        interaction['19'] = '{0} meows at {1}.'.format(executer, victim)
        interaction['20'] = '{0} maow meeeeeeoooooows at {1}.'.format(executer, victim)
        interaction['21'] = '{0} purrs at {1}.'.format(executer, victim)
        interaction['22'] = '{0} wuffs at {1}.'.format(executer, victim)
        interaction['23'] = '{0} wwwwuuuuuuuuuffff wwwwuuuuffffs at {1}.'.format(executer, victim)
        interaction['24'] = '{0} sniffs {1}.'.format(executer, victim)
        interaction['25'] = '{0} crawls on all fours to {1}.'.format(executer, victim)
        interaction['26'] = '{0} stands wearing a latex maid uniform, offering a glass of wine to {1}.'.format(executer, victim)
        interaction['27'] = '{0} waves their feet in the face of {1}.'.format(executer, victim)
        interaction['28'] = '{0} gives a candy bar to {1}.'.format(executer, victim)
        interaction['29'] = '{0} throws a rock at {1}.'.format(executer, victim)
        interaction['30'] = '{0} licks {1}.'.format(executer, victim)
    ...
    async def poke(self, context, user : discord.Member):
        ...
        poke = {}
        poke['1'] = '{0} pokes {1}\'s eye.'.format(pokedoer, victim)
        poke['2'] = '{0} boops {1}\'s snoot.'.format(pokedoer, victim)
        poke['3'] = '{0} pokes {1} with a stick.'.format(pokedoer, victim)
        poke['4'] = '{0} pokes {1} with a pin.'.format(pokedoer, victim)
        poke['5'] = '{0} pokes {1} on facebook.'.format(pokedoer, victim)
