    ...
    async def _seed(self, context):
        ...
        if not self.gardeners[author.id]['current']:
            ...
            if month == 1:
                ...
                self.plants['plants'].append({"name": "Chocolate Rose", "article": "a", "time": 70800, "rarity": "event", "image": "http://i.imgur.com/Sqg6pcG.jpg", "health": 100, "degradation": 5.5, "threshold": 110, "badge": "Annualsary", "reward": 21600})
                event_plant = True
            elif month == 3:
                self.plants['plants'].append({"name": "Shamrock", "article": "a", "time": 70800, "rarity": "event", "image": "http://i.imgur.com/kVig04M.jpg", "health": 100, "degradation": 5.5, "threshold": 110, "badge": "Annualsary", "reward": 21600})
                event_plant = True
            elif month == 4:
                self.plants['plants'].append({"name": "Easter Egg Eggplant", "article": "an", "time": 70800, "rarity": "event", "image": "http://i.imgur.com/5jltGQa.jpg", "health": 5.5, "degradation": 0, "threshold": 110, "badge": "Annualsary", "reward": 21600})
                event_plant = True
            elif month == 10:
                self.plants['plants'].append({"name": "Jack O' Lantern", "article": "a", "time": 70800, "rarity": "event", "image": "http://i.imgur.com/efApsxG.jpg", "health": 5.5, "degradation": 0, "threshold": 110, "badge": "Annualsary", "reward": 21600})
                event_plant = True
            elif month == 12:
